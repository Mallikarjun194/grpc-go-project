...
type CalcServiceClient interface {
	Calculator(ctx context.Context, in *CalRequest, opts ...grpc.CallOption) (*CalResp, error)
}
...
func (c *calcServiceClient) Calculator(ctx context.Context, in *CalRequest, opts ...grpc.CallOption) (*CalResp, error) {
	out := new(CalResp)
	err := c.cc.Invoke(ctx, "/calculator.CalcService/Calculator", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CalcServiceServer interface {
	Calculator(context.Context, *CalRequest) (*CalResp, error)
...
func (UnimplementedCalcServiceServer) Calculator(context.Context, *CalRequest) (*CalResp, error) {
...
func _CalcService_Calculator_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/calculator.CalcService/Calculator",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalcServiceServer).Calculator(ctx, req.(*CalRequest))
	}

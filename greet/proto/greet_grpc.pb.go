...
type GreetServiceClient interface {
	Greet(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResp, error)
...
func (c *greetServiceClient) Greet(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResp, error) {
	out := new(GreetResp)
...
func (x *greetServiceGreetManyTimesClient) Recv() (*GreetResp, error) {
	m := new(GreetResp)
...
type GreetServiceServer interface {
	Greet(context.Context, *GreetRequest) (*GreetResp, error)
...
func (UnimplementedGreetServiceServer) Greet(context.Context, *GreetRequest) (*GreetResp, error) {
...
func (x *greetServiceGreetManyTimesServer) Send(m *GreetResp) error {

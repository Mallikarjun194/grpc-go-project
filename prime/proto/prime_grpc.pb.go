...
type PrimeServiceClient interface {
	Prime(ctx context.Context, in *PrimeReq, opts ...grpc.CallOption) (PrimeService_PrimeClient, error)
}
...
func (c *primeServiceClient) Prime(ctx context.Context, in *PrimeReq, opts ...grpc.CallOption) (PrimeService_PrimeClient, error) {
...
func (x *primeServicePrimeClient) Recv() (*PrimeResp, error) {
	m := new(PrimeResp)
...
type PrimeServiceServer interface {
	Prime(*PrimeReq, PrimeService_PrimeServer) error
...
func (UnimplementedPrimeServiceServer) Prime(*PrimeReq, PrimeService_PrimeServer) error {
...
func (x *primeServicePrimeServer) Send(m *PrimeResp) error {
